...
<body style="background-color: #212121">
    ...
    <script type="text/javascript">
        function irCrear() {
            document.getElementById("mainform").action = "mazos_opciones/crear_mazo.php";
            document.getElementById("mainform").submit();
        }

        function irModificar() {
            document.getElementById("mainform").action = "mazos_opciones/modificar_mazo.php";
            document.getElementById("mainform").submit();
        }
